...
urlpatterns = [
    ...
    path("betty's/pedido/", views.PedidoCreateView.as_view(), name="pedido"),
    path("betty's/reservacion/", views.ReservacionCreateView.as_view(), name="reservacion"),
    path("betty's/sugerencia/", views.SugerenciaComidasCreateView.as_view(), name="sugerencia"),
